...
#include "realsense_msgs/msg/imu_info__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    cdr << ros_message.noise_variances;
  }
  // Member: bias_variances
  {
    cdr << ros_message.bias_variances;
  }
  return true;
}
  ...
  size_t current_alignment)
{
  ...
  {
    size_t array_size = 3;
    size_t item_size = sizeof(ros_message.noise_variances[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: bias_variances
  {
    size_t array_size = 3;
    size_t item_size = sizeof(ros_message.bias_variances[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
...
{
  auto typed_message =
    static_cast<const realsense_msgs::msg::IMUInfo *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<realsense_msgs::msg::IMUInfo *>(
    untyped_ros_message);
...
{
  return max_serialized_size_IMUInfo(full_bounded, 0);
}
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_realsense_msgs
const rosidl_message_type_support_t *
get_message_type_support_handle<realsense_msgs::msg::IMUInfo>()
{
  return &realsense_msgs::msg::typesupport_fastrtps_cpp::_IMUInfo__handle;
}
