...
#include "realsense_msgs/msg/imu_info__rosidl_typesupport_fastrtps_c.h"
...
#include "realsense_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_realsense_msgs
...
using _IMUInfo__ros_msg_type = realsense_msgs__msg__IMUInfo;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_realsense_msgs
size_t get_serialized_size_realsense_msgs__msg__IMUInfo(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _IMUInfo__ros_msg_type * ros_message = static_cast<const _IMUInfo__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _IMUInfo__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_realsense_msgs__msg__IMUInfo(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_realsense_msgs
size_t max_serialized_size_realsense_msgs__msg__IMUInfo(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_realsense_msgs__msg__IMUInfo(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, realsense_msgs, msg, IMUInfo)() {
