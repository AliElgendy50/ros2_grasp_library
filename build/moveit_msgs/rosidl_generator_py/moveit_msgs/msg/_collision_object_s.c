...
bool moveit_msgs__msg__collision_object__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "moveit_msgs.msg._collision_object.CollisionObject",
  ...
  {  // type
    ...
    if (!moveit_msgs__msg__object_type__convert_from_py(field, &ros_message->type)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
PyObject * moveit_msgs__msg__collision_object__convert_to_py(void * raw_ros_message)
{
  ...
  {  // type
    PyObject * field = NULL;
    field = moveit_msgs__msg__object_type__convert_to_py(&ros_message->type);
    if (!field) {
      return NULL;
    }
    {
