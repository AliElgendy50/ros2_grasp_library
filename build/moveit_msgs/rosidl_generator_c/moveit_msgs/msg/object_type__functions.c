...
{
  moveit_msgs__msg__ObjectType * msg = (moveit_msgs__msg__ObjectType *)malloc(sizeof(moveit_msgs__msg__ObjectType));
  if (!msg) {
    return NULL;
  }
...
moveit_msgs__msg__ObjectType__Sequence__init(moveit_msgs__msg__ObjectType__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (moveit_msgs__msg__ObjectType *)calloc(size, sizeof(moveit_msgs__msg__ObjectType));
    if (!data) {
      return false;
    }
...
{
  moveit_msgs__msg__ObjectType__Sequence * array = (moveit_msgs__msg__ObjectType__Sequence *)malloc(sizeof(moveit_msgs__msg__ObjectType__Sequence));
  if (!array) {
    return NULL;
  }
