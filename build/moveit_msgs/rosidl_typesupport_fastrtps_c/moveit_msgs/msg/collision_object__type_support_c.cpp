...
#include "moveit_msgs/msg/collision_object__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/pose__functions.h"  // mesh_poses, plane_poses, primitive_poses
#include "moveit_msgs/msg/object_type__functions.h"  // type
#include "rosidl_generator_c/string.h"  // id
#include "rosidl_generator_c/string_functions.h"  // id
#include "shape_msgs/msg/mesh__functions.h"  // meshes
#include "shape_msgs/msg/plane__functions.h"  // planes
#include "shape_msgs/msg/solid_primitive__functions.h"  // primitives
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: plane_poses
  {
    ...
    if (!geometry_msgs__msg__Pose__Sequence__init(&ros_message->plane_poses, size)) {
      return "failed to create array for field 'plane_poses'";
    }
    auto array_ptr = ros_message->plane_poses.data;
    for (size_t i = 0; i < size; ++i) {
      if (!callbacks->cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_moveit_msgs__msg__ObjectType(
  ...
  size_t current_alignment)
{
  ...
  // member: type
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        max_serialized_size_moveit_msgs__msg__ObjectType(
        full_bounded, current_alignment);
    }
  }
  // member: primitives
