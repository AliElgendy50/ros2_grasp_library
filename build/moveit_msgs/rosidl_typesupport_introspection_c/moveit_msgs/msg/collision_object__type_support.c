...
#include <stddef.h>
#include "moveit_msgs/msg/collision_object__rosidl_typesupport_introspection_c.h"
...
// Member `type`
#include "moveit_msgs/msg/object_type.h"
// Member `type`
...
static rosidl_typesupport_introspection_c__MessageMember CollisionObject__rosidl_typesupport_introspection_c__CollisionObject_message_member_array[10] = {
  {
    "header",  // name
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, moveit_msgs, msg, CollisionObject)() {
  ...
  CollisionObject__rosidl_typesupport_introspection_c__CollisionObject_message_member_array[2].members_ =
