...
#include "moveit_msgs/msg/collision_object__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const moveit_msgs::msg::ObjectType &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  moveit_msgs::msg::ObjectType &);
size_t get_serialized_size(
  const moveit_msgs::msg::ObjectType &,
  size_t current_alignment);
size_t
  ...
  size_t current_alignment)
{
  ...
  // Member: type
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        moveit_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_ObjectType(
        full_bounded, current_alignment);
    }
  }
