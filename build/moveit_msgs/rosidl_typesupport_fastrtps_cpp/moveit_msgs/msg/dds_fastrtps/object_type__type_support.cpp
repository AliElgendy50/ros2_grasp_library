...
#include "moveit_msgs/msg/object_type__rosidl_typesupport_fastrtps_cpp.hpp"
#include "moveit_msgs/msg/object_type__struct.hpp"
...
cdr_serialize(
  const moveit_msgs::msg::ObjectType & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  moveit_msgs::msg::ObjectType & ros_message)
{
  // Member: key
  cdr >> ros_message.key;
...
{
  auto typed_message =
    static_cast<const moveit_msgs::msg::ObjectType *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<moveit_msgs::msg::ObjectType *>(
    untyped_ros_message);
...
get_message_type_support_handle<moveit_msgs::msg::ObjectType>()
{
  return &moveit_msgs::msg::typesupport_fastrtps_cpp::_ObjectType__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, moveit_msgs, msg, ObjectType)() {
  return &moveit_msgs::msg::typesupport_fastrtps_cpp::_ObjectType__handle;
}
