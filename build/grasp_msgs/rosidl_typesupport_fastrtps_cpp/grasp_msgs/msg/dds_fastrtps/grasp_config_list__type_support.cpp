...
#include "grasp_msgs/msg/grasp_config_list__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const grasp_msgs::msg::GraspConfig &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: grasps
  {
    ...
    for (size_t i = 0; i < size; i++) {
      grasp_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
  ...
  grasp_msgs::msg::GraspConfigList & ros_message)
{
  ...
  // Member: grasps
  {
    ...
    for (size_t i = 0; i < size; i++) {
      grasp_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  // Member: grasps
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        grasp_msgs::msg::typesupport_fastrtps_cpp::get_serialized_size(
  ...
  size_t current_alignment)
{
  ...
  // Member: grasps
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        grasp_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_GraspConfig(
        full_bounded, current_alignment);
    }
  }
...
{
  auto typed_message =
    static_cast<const grasp_msgs::msg::GraspConfigList *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<grasp_msgs::msg::GraspConfigList *>(
    untyped_ros_message);
...
{
  return max_serialized_size_GraspConfigList(full_bounded, 0);
}
...
{
  return &grasp_msgs::msg::typesupport_fastrtps_cpp::_GraspConfigList__handle;
}
