...
#include "grasp_msgs/msg/grasp_config__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  return ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, grasp_msgs, msg, GraspConfig)();
}
