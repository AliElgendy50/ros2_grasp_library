...
bool grasp_msgs__msg__samples_msg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp(
        "grasp_msgs.msg._samples_msg.SamplesMsg",
        full_classname_dest, 38) == 0);
  }
  grasp_msgs__msg__SamplesMsg * ros_message = _ros_message;
  {  // header
...
PyObject * grasp_msgs__msg__samples_msg__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("grasp_msgs.msg._samples_msg");
