...
#include "grasp_msgs/msg/grasp_config__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/point__functions.h"  // bottom, sample, surface, top
#include "geometry_msgs/msg/vector3__functions.h"  // approach, axis, binormal
#include "std_msgs/msg/float32__functions.h"  // score, width
...
using _GraspConfig__ros_msg_type = grasp_msgs__msg__GraspConfig;
  ...
  void * untyped_ros_message)
{
  ...
  _GraspConfig__ros_msg_type * ros_message = static_cast<_GraspConfig__ros_msg_type *>(untyped_ros_message);
  // Field name: bottom
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_geometry_msgs__msg__Point(
    &(ros_message->bottom), current_alignment);
  // field.name top

  current_alignment += get_serialized_size_geometry_msgs__msg__Point(
    &(ros_message->top), current_alignment);
  // field.name surface
...
static uint32_t _GraspConfig__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_grasp_msgs__msg__GraspConfig(
...
static size_t _GraspConfig__max_serialized_size(bool & full_bounded)
{
  return max_serialized_size_grasp_msgs__msg__GraspConfig(
    full_bounded, 0);
}
